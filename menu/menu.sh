...
Exp2=$(curl -sS https://raw.githubusercontent.com/vhzv/permisibang/refs/heads/main/ipmini | grep $MYIP | awk '{print $3}')
export RED='\033[0;31m'
...
mkdir /etc/github
echo "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" > /etc/github/api
echo "angga.03k@gmail.com" > /etc/github/email
echo "vhzv" > /etc/github/username
m-ip
fi
}
...
clear;clear;clear
echo -e " $COLOR1╭══════════════════════════════════════════════════════════╮${NC}"
echo -e " $COLOR1│${NC} ${COLBG1}               ${WH} •  VHZVPN PREMIUM TUNNELING •           ${NC} $COLOR1│ $NC"
echo -e " $COLOR1╰══════════════════════════════════════════════════════════╯${NC}"
echo -e " $COLOR1╭══════════════════════════════════════════════════════════╮${NC}"
...
cd
rm -rf *
wget https://raw.githubusercontent.com/vhzv/jembud/refs/heads/main/m-update.sh
clear
