...
sldns() {
wget https://raw.githubusercontent.com/vhzv/jembud/refs/heads/main/slowdns/ && chmod +x installsl.sh && ./installsl.sh
}
res1() {
wget https://raw.githubusercontent.com/vhzv/jembud/refs/heads/main/slowdns/ && chmod +x rmbl.sh && ./rmbl.sh
clear
}
res2() {
wget https://raw.githubusercontent.com/vhzv/jembud/refs/heads/main/slowdns/ && chmod +x rmbl1.sh && ./rmbl1.sh
clear
}
res3() {
wget https://raw.githubusercontent.com/vhzv/jembud/refs/heads/main/slowdns/ && chmod +x rmbl2.sh && ./rmbl2.sh
clear
}
clear
echo -e "$COLOR1╭══════════════════════════════════════════╮${NC}"
...
wget -O /usr/local/bin/modxray https://github.com/dharak36/XrayDynamicPath/releases/download/xray/xray.linux.64bit &> /dev/null
fi
cd
